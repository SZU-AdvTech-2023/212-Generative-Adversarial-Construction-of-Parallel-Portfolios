...
#sys.path.append('/home/liuwei/GAST/ACPP')
...
class parallel_solver_wrapper(object):
    ...
    def parse_args(self, argv):
        ...
        [self._thread_to_solver, self._thread_to_params, _] = parser.parse(self._params)
    ...
    def __construct_cmd(self, solver_path, parameter_list):
        ...
        if 'LKH' in solver_path:
            optimumFile = ('/home/liuwei/GAST/ACPP/AC/scenarios/lkh/'
                           'TSP_optimum_zql.json')
            if 'AC_output/GAST' in self._instance:
